<template>
         ...
         <br>
          <div class="row" v-if="productosFiltrados.length > 0">
             <div class="col-lg-2 col-sm-12 d-flex" v-for="producto in productosFiltrados" :key="producto.idProducto">
                <div class="productset flex-fill" :class="{ 'active': isProductoSeleccionado(producto) }" @click="agregarProducto(producto)">
 ...
 <script>
 export default {
    props: ['productosFiltrados', 'isProductoSeleccionado', 'agregarProducto', 'getProveedorImage']
 };
 </script>
