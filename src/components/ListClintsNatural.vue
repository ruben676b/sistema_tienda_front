            ...
            <form @submit.prevent="editarCliente">
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  class="form-control"
                  id="editApellido"
                  v-model="clienteEditado.apellido"
                  required
                />
              </div>
              <div class="form-group">
    ...
    async borrarCliente(idCliente) {
      try {
        const response = await axios.delete(
          `http://localhost:3000/api/v1/clientes-naturales/${idCliente}`
        );
    ...
    async editarCliente() {
      try {
        const response = await axios.put(
          `http://localhost:3000/api/v1/clientes-naturales/${this.clienteEditado.id}`,
          this.clienteEditado
        );
