      ...
      <div class="row" style="padding: 10px">
                      ...
                      <span class="selection">
                        ...
                        >
                          <span
                            ...
                            id="select2-y9w0-container"
                            role="textbox"
                            aria-readonly="true"
                            title="Walk-in Customer"
                            >Cliente sin cita previa</span
                          >
                        </span>
                      </span>
        ...
        <div class="col-md-4">
          ...
          <div>
            ...
            <select
              class="js-example-basic-single select2 select2-hidden-accessible"
              data-select2-id="18"
              tabindex="-1"
              aria-hidden="true"
            >
              ...
              <option data-select2-id="100">purple</option></select
            ><span
              ...
              ><span class="selection"
                ><span
                  ...
                  tabindex="0"
                  aria-disabled="false"
                  aria-labelledby="select2-htm5-container"
                  ><span
                    class="select2-selection__rendered"
                    id="select2-htm5-container"
                    role="textbox"
                    aria-readonly="true"
                    title="orange"
                    >Factura</span
          ...
          <div class="col-lg-12 col-sm-12 tabs_wrapper">
            ...
            >
              <div class="owl-stage-outer">
                <div class="owl-stage row">
                  <div
                    class="owl-item col-lg-2 col-sm-12 d-flex"
            ...
            <div class="tabs_container">
              <div class="tab_content active">
                <div class="row">
                  <div
                    class="col-lg-2 col-sm-12 d-flex"
                  ...
                  >
                    ...
                    >
                      <div class="productsetimg">
                        <img
                          :src="getProveedorImage(producto.RutaImagen)"
                          alt="img"
                        />
                        <h6>Cantidad: {{ producto.Stock }}</h6>
                        <div
                          class="check-product"
                          v-if="isProductoSeleccionado(producto)"
                        >
        ...
        <div class="col-md-8">
          <div class="card-body pt-0">
            <div class="totalitem">
              ...
              <a href="javascript:void(0);" @click="limpiarProductos"
                >Borrar todo</a
              >
            </div>
                  ...
                  <div class="productimg">
                    ...
                    <div class="productcontet">
                      <h4>
                        ...
                        >
                          <img
                            src="../../public/img/icons/edit-5.svg"
                            alt="img"
                          />
                        </a>
                      </h4>
            ...
            <div class="setvaluecash">
              <ul>
                ...
                <li>
                  <a href="javascript:void(0);" class="paymentmethod">
                    <img
                      src="../../public/img/icons/debitcard.svg"
                      alt="img"
                      class="me-2"
                    />
                    <font>Débito</font>
  ...
  methods: {
    isProductoSeleccionado(producto) {
      ...
      console.log(
        ...
        JSON.parse(JSON.stringify(this.productosSeleccionados))
      );
    ...
    async obtenerProductosPorCategoria(categoriaId) {
      try {
        const response = await axios.get(
          `http://localhost:3000/api/v1/productos/filtrar/${categoriaId}`
        );
        if (response.data.success) {
