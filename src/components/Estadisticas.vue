                                    ...
                                    <div class="graph-sets">
                                        ...
                                        <div class="dropdown">
                                            <button class="btn btn-white btn-sm dropdown-toggle" type="button"
                                                ...
                                                2022 <img src="../../public/img/icons/dropdown.svg" alt="img"
                                                    class="ms-2">
                                            </button>
                                        ...
                                        <table class="table datatable ">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="productimgname">
                                                        <a href="productlist.html" class="product-img">
                                                            <img src="../../public/img/product/product22.jpg"
                                                                alt="product">
                                                        </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="productimgname">
                                                        <a href="productlist.html" class="product-img">
                                                            <img src="../../public/img/product/product23.jpg"
                                                                alt="product">
                                                        </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="productimgname">
                                                        <a href="productlist.html" class="product-img">
                                                            <img src="../../public/img/product/product24.jpg"
                                                                alt="product">
                                                        </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="productimgname">
                                                        <a href="productlist.html" class="product-img">
                                                            <img src="../../public/img/product/product6.jpg"
                                                                alt="product">
                                                        </a>
