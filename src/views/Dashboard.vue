<template>
  <div>
    ...
    <div class="main-wrapper">
      ...
      <div class="header">
        <div v-if="isAdmin" class="header-left active">
        ...
        <div v-if="!isAdmin" class="header-left ">
          <router-link to="/dashboard/ventaAdd" class="logo">
            <img src="../../public/img/fresko-log.png" alt="logo" />
          </router-link>
          <a id="toggle_btn" href="javascript:void(0);"></a>
        ...
        <div  v-if="!isAdmin" class="header-right active " style="text-align: center; padding: 10px;font-weight: bold;">
        ...
        <div class="sidebar-inner slimscroll">
          <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <ul :style="{ display: submenus.product ? 'block' : 'none' }">
                  ...
                  <li>
                    <router-link to="/dashboard/listCate"
                      >Lista de Categorías</router-link
                    >
                  </li>
                  <li>
                  ...
                  <li>
                    <router-link to="/dashboard/modifyCate"
                      >Modificar Categoría</router-link
                    >
                  </li>
                  <li>
                    <router-link to="/dashboard/marca"
                      >Lista de Marcas</router-link
                    >
                  </li>
                  <li>
                    <router-link to="/dashboard/addmarca"
                      >Agregar Marca</router-link
                    >
                  </li>
                  <li>
                    <router-link to="/dashboard/gestionstock"
                      >Gestión Stock</router-link
                    >
                  </li>
                </ul>
              </li>
              ...
              <li class="submenu">
                <a
                  :class="submenus.personas ? 'subdrop' : ''"
              ...
              <li v-if="isAdmin" class="submenu">
                <a
                  :class="submenus.finanzas ? 'subdrop' : ''"
                ...
                <ul :style="{ display: submenus.finanzas ? 'block' : 'none' }">
                  <li>
                    <router-link to="/dashboard/addcaja"
                      >Apertura de caja</router-link
                    >
                  </li>
                  <li>
                    <router-link to="/dashboard/formaspago"
                  ...
                  <li>
                    <router-link to="/dashboard/cajalist"
                      >Datos de Cajas</router-link
                    >
                  </li>
                </ul>
              </li>
